        ...
        >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-4 max-w-5xl mx-auto">
                ...
                <div className="space-y-2">
                    ...
                    {showNewForm ? (
                        ...
                        <button
                            ...
                            className="w-full flex items-center gap-2 px-4 py-3 rounded-2xl border border-dashed border-white/10 text-gray-500 hover:text-white hover:border-violet-500/50 hover:bg-violet-500/10 hover:shadow-[0_0_20px_rgba(139,92,246,0.15)] text-sm transition-all"
                        >
                ...
                {activeNote ? (
                    <GlassCard className="h-full min-h-[500px] flex flex-col p-5 sm:p-6 space-y-4">
                        ...
                        <AnimatePresence mode="wait">
                            {activeNote.isLocked ? (
                                ...
                                <motion.div key="editor" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="flex-1 relative flex flex-col min-h-[300px]">
                                    <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,rgba(139,92,246,0.07)_0%,transparent_50%)] pointer-events-none rounded-2xl" />
                                    <textarea
                                        className="flex-1 w-full bg-black/50 border border-white/5 rounded-2xl p-4 text-gray-200 text-sm leading-relaxed resize-none focus:outline-none focus:ring-1 focus:ring-violet-500/40 shadow-inner z-10 custom-scrollbar"
                    ...
                    <div className="flex flex-col items-center justify-center min-h-[400px] border border-white/5 bg-black/20 rounded-3xl text-gray-500 space-y-6">
                        <div className="relative w-32 h-32 flex items-center justify-center">
                            <div className="absolute inset-0 bg-violet-500/10 rounded-full blur-2xl" />
                            <FileText className="w-16 h-16 text-violet-500/20 relative z-10 drop-shadow-[0_0_15px_rgba(139,92,246,0.3)]" />
                            <Lock className="w-6 h-6 text-violet-400 absolute bottom-6 right-6 z-20" />
                        </div>
                        <p className="text-sm font-medium">{t.notes.selectNote || 'Select a note to view or edit'}</p>
                    </div>
                )}
            </div>
        </motion.div>
