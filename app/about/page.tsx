...
export default function About() {
    return (
        ...
        >
            ...
            <GlassCard className="max-w-2xl mx-auto space-y-12 sm:space-y-16 text-center px-5 py-8 sm:px-10 sm:py-16">
                <div className="w-16 h-16 sm:w-20 sm:h-20 mx-auto rounded-2xl bg-gradient-to-br from-indigo-500 to-violet-500 shadow-lg shadow-indigo-500/20 flex flex-col items-center justify-center mb-8">
